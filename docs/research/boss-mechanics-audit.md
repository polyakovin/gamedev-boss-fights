...
| **Sound detection**                  | The boss lacks the player's exact position without a sound event, making movement and attack noise part of stealth.         | The blind [Old Hero](https://demonssouls.wikidot.com/walk4-2-boss) approaches the source of damage while silent movement hinders detection.               |

### Encounter objective and vulnerability

| Mechanic                                 | Concise definition                                                                                       | Verified example                                                                                                                                                                                             |
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Objective-linked invulnerability**     | The boss ignores normal damage until separate protection sources are disabled.                           | [Rennala](https://eldenring.wiki.gg/wiki/Rennala) requires finding and striking three singing scholars to break the sphere.                                                                                  |
| **Wave-clear objective**                 | The boss has no conventional health objective; clearing a fixed number of waves advances the fight.      | [Great Gideon](https://bindingofisaacrebirth.wiki.gg/wiki/Great_Gideon) ends after six enemy waves.                                                                                                          |
| **Environmental weapon / device**        | A stationary arena object deals the primary damage and must be reached or prepared.                      | [Dragon God](https://demonssouls.wikidot.com/walk2-3-boss) is defeated with two ballistae after a stealth route between cover points.                                                                        |
| **Encounter-specific tool**              | The encounter grants or activates a tool whose special property primarily applies to this boss.          | [Serpent-Hunter](https://eldenring.wiki.gg/wiki/Serpent-Hunter) activates its ranged attacks against the God-Devouring Serpent and Rykard.                                                                   |
| **Player-controlled boss**               | The system assigns a real player as the boss opponent and substitutes AI when no candidate is available. | A network player can become Old Monk under the conditions described in [Old Monk Summon](https://demonssouls.wikidot.com/black-phantoms).                                                                    |
| **Projectile rally / dead man's volley** | The player sends an attack back at the boss; repeated reflections can create a rhythmic exchange.        | Zelda's [Dead Man's Volley](https://zelda.fandom.com/wiki/Dead_Man%27s_Volley) exposes a critical point or deals damage. This is narrower than generic reflection because the exchange itself is played out. |
| **Baited collision / self-hit**          | The player causes the boss to hit an obstacle, swallow a dangerous object, or enter its own hazard.      | Wormwood, Big Chub, and Carrion Queen can swallow a placed bomb; [Great Gideon](https://bindingofisaacrebirth.wiki.gg/wiki/Great_Gideon) also has a hidden bomb interaction.                                 |
| **Posture / stagger gauge**              | Pressure fills or drains a separate gauge; breaking it opens a required critical action.                 | Sekiro centers fights on posture and Deathblow; Lies of P connects Perfect Guard, Groggy, and Fatal Attack in its [Guard description](https://lies-of-p.fandom.com/wiki/Guard).                              |
...
| Mechanic                             | Concise definition                                                                                                                 | Verified example                                                                                                                                                                                          |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Status buildup**                   | Hits fill a separate gauge; the effect occurs only at its threshold.                                                               | [Guardian Ape](https://sekiro-shadows-die-twice.fandom.com/wiki/Guardian_Ape) builds Terror with its scream.                                                                                              |
| **Instant-kill / execution**         | A separate condition bypasses ordinary damage and ends the attempt immediately.                                                    | Full Terror kills in Sekiro; daytime [Empress of Light](https://terraria.wiki.gg/wiki/Empress_of_Light) attacks normally kill in one hit.                                                                 |

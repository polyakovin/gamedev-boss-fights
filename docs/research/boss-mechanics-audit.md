...
| **Maximum-health reduction**         | An attack lowers the health ceiling temporarily or permanently, rather than only current health.                                   | [The Tree of Men][max-health-tree] demonstrates Wounding in 2D; [Maliketh][max-health-maliketh] reduces maximum HP in 3D; [Demon King Ganondorf][max-health-ganondorf] destroys heart containers.         |
...
[max-health-tree]: https://www.neoseeker.com/salt-and-sanctuary/walkthrough/Red_Hall_of_Cages_%28Part_2%29
[max-health-maliketh]: https://eldenring.wiki.gg/wiki/Destined_Death_%28Status_Effect%29
[max-health-ganondorf]: https://zeldadungeon.net/wiki/Gloom

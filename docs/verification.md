...
- Browser suite: 12 tests covering all locale routes, the localized home-page purpose and six-link site map, the compact two-column lesson header, stacked 375 px layouts, shared preview artwork, six design lenses, six external boss-behavior references, seven learning sources, and the community review note per locale, removal of the quiz block, language switching, Arabic direction, both animation outcomes, keyboard playback/seeking, reduced-motion behavior, and content without JavaScript. The homepage introduction, mechanic card (rule and design goal), and full navigation fit within a 1280 × 720 viewport in every locale; footer content may follow below. Navigation counts reflect published content. On mobile, the sections stack without horizontal overflow.
- Static build: 17 pages, local assets, canonical/alternate links, sitemap, and a language gateway.
- Visual inspection: Russian and Arabic desktop pages, Hindi and Bengali mobile pages, the Russian catalog at 1280 × 720 and 375 × 812, and the setting-neutral boss/player diagram.

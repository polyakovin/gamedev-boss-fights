...
- Browser suite: 11 tests covering all locale routes, the localized home-page purpose and six-link site map, the compact two-column lesson header, stacked 375 px layouts, shared preview artwork, six design lenses, six external boss-behavior references, seven learning sources, and the community review note per locale, removal of the quiz block, language switching, Arabic direction, both animation outcomes, keyboard playback/seeking, reduced-motion behavior, and content without JavaScript.

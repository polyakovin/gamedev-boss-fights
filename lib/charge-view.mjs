    ...
    <div class="charge-demo__canvas">
      ...
      >
        ...
        <path
          ...
          stroke-width="2"
        />
        <g data-charge-lane transform="translate(280 560) rotate(-90)">
          <rect
            x="0"
            y="-49"
            width="430"
          ...
          />
          <rect x="0" y="-49" width="430" height="98" rx="18" fill="url(#charge-hatch)" />
          <path
            d="M 88 0 H 402 M 383 -11 L 402 0 L 383 11"
            fill="none"
            stroke="#b45d49"
            stroke-width="2.5"
        ...
        <path
          data-charge-dodge
          d="M 258 260 H 166 M 177 252 L 166 260 L 177 268"
          fill="none"
          stroke="#27786d"
          stroke-width="3"
        ...
        />
        <g data-charge-boss transform="translate(280 560) rotate(-90)">
          ${CHARGE_ART.tank}
          <g
        ...
        <g data-charge-player transform="translate(154 260)">${CHARGE_ART.monster}</g>
        <text
        ...
        <g data-charge-status transform="translate(280 55)">
          <rect x="-126" y="-17" width="252" height="34" rx="17" fill="var(--diagram-status)" />

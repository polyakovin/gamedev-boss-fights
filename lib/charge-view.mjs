  ...
  >
    ...
    <div class="charge-demo__canvas">
      ...
      >
        ...
        />
        <g data-charge-boss data-charge-art="tank" transform="translate(180 240)">
        ...
        <g data-charge-player data-charge-art="monster" transform="translate(610 114)">
...
export function renderChargeThumbnail(id) {
  return /* HTML */ `<svg viewBox="0 0 360 160">
    ...
    <rect x="60" y="57" width="60" height="50" rx="10" fill="#c48440" />
    <rect x="99" y="61" width="20" height="42" rx="3" fill="#4d4d3d" />
    <circle cx="205" cy="31" r="14" fill="#17756b" />
    <circle cx="210" cy="27" r="3" fill="#dfeae2" />
  </svg>`;
}

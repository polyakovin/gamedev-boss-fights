...
export function renderEncounterArena(id, { minimal = false, quiet = false } = {}) {
  const key = escape(id);
  if (quiet)
    return /* HTML */ `<defs>
        <radialGradient id="encounter-light-${key}" cx="50%" cy="38%" r="76%">
          <stop offset="0" stop-color="#2b403d" />
          <stop offset="1" stop-color="#17282a" />
        </radialGradient>
      </defs>
      <g aria-hidden="true">
        <rect width="560" height="960" fill="url(#encounter-light-${key})" />
        <path
          d="M 0 322 H 560 M 0 655 H 560"
          fill="none"
          stroke="#8fa89a"
          stroke-opacity=".055"
          stroke-width="3"
        />
        <path
          d="M 28 28 V 932 M 532 28 V 932"
          fill="none"
          stroke="#8fa89a"
          stroke-opacity=".08"
          stroke-width="2"

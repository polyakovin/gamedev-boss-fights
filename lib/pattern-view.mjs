import { PATTERN_DURATION, patternFrame } from '../src/pattern-model.mjs';
...
const sweepLayer = /* HTML */ `<g data-pattern-sweep opacity="0">
  <path
    d="M 492 142.5 A 250 250 0 0 1 500.7 392.4 L 438.9 359.5 A 180 180 0 0 0 432.6 179.6 Z"
    fill="var(--signal)"
    fill-opacity=".1"
    stroke="var(--signal)"
    stroke-width="1.5"
  />
  <path
    d="M 492 142.5 A 250 250 0 0 1 500.7 392.4"
    fill="none"
    stroke="var(--signal)"
    stroke-width="18"
    stroke-opacity=".15"
  />
  <path d="M 492 142.5 A 250 250 0 0 1 500.7 392.4" fill="none" stroke="#ffe5b8" stroke-width="4" />
  <path d="M 432.6 179.6 L 490 140 L 499 137 L 486 152 Z" fill="#f9e3b5" />
</g>`;
...
const projectile = (x, y) =>
  `<g transform="translate(${x} ${y})"><path d="M 0 -34 L 8 0 L 0 11 L -8 0 Z" fill="var(--signal)" opacity=".24" /><circle r="10" fill="var(--signal)" opacity=".18" /><path d="M 0 -9 L 6 1 L 0 9 L -6 1 Z" fill="#ffe6bd" /></g>`;
  ...
  >
    <div class="pattern-demo__canvas">
      ...
      >
        ...
        ${renderEncounterArena(id)}${sweepLayer}${slamLayer}${summonLayer}${volleyLayer}

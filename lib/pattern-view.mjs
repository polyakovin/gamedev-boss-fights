import { BOSS_LABEL_OFFSET_Y, PATTERN_DURATION } from '../src/pattern-model.mjs';
...
const arena = (id) =>
  /* HTML */ ` <defs>
    ...
    <rect
      ...
      height="922"
      rx="21"
      fill="url(#pattern-grid-${escape(id)})"
    />`;
  ...
  >
    <div class="pattern-demo__canvas">
      ...
      >
        ...
        <g data-pattern-boss transform="translate(280 275)">${CHARACTER_ART.kern}</g>
        <g data-pattern-player transform="translate(390 700)">${CHARACTER_ART.tavi}</g>
        <text
          data-pattern-boss-label
          x="280"
          y="${275 + BOSS_LABEL_OFFSET_Y}"
          text-anchor="middle"

...
export const AUTHOR = Object.freeze({
  name: 'Igor Polyakov',
  github: 'https://github.com/polyakovin',
  website: 'https://polyakovin.ru',
  telegram: 'https://t.me/polyakovin',
  linkedin: 'https://www.linkedin.com/in/polyakovin/',
  email: 'mailto:web@polyakovin.ru',
});

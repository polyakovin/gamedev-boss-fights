...
const SCENE_BACKGROUND_COUNT = Object.freeze({ 'absorption-power-up': 3 });
  ...
  >
    <div class="blueprint-demo__canvas">
      ...
      >
        ...
        ${backgroundLayer} ${sourceInFront ? '' : primitiveLayer} ${renderEncounterEffects()}
        ${
          initial.decoy
...
export function renderBlueprintThumbnail(mechanicId, id) {
  ...
  >
    ...
    />
    ${backgroundGeometryLayer} ${sourceInFront ? '' : geometryLayer}
    <g
